...
{{< figure src="img/from_surplus.jpg" alt="Sun Ultra 24 from surplus" caption="My Sun Ultra 24 after taking it home from surplus."  >}}
...
{{< figure src="img/old_insides.jpg" alt="Brand-new Sun Ultra 24 insides" caption="Brand-new Sun Ultra 24 insides"  >}}

{{< figure src="img/old_exterior.jpg" alt="Sun Ultra 24 exterior" caption="Sun Ultra 24 exterior"  >}}
...
{{< figure src="img/new_insides.jpg" alt="Post-build computer" caption="My 'new' Sun Ultra 24"  >}}
...
{{< figure src="img/new_power_supply.jpg" alt="New power supply installed" caption="New power supply installed"  >}}
...
{{< figure src="img/new_pcie_slots.jpg" alt="Mismatched PCIe slot covers" caption="Mismatched PCIe slot covers"  >}}
...
{{< figure src="img/old_fan.jpg" alt="Sun Ultra 24 rear case fan mount" caption="Sun Ultra 24 rear case fan mount"  >}}
...
{{< figure src="img/old_header.jpg" alt="Sun Ultra 24 front panel header" caption="Sun Ultra 24 front panel header"  >}}

This is the front panel header for my Asus Z97-AR.

{{< figure src="img/asus_z97-ar_header.jpg" alt="Asus Z97-AR front panel header" caption="Asus Z97-AR front panel header"  >}}
...
{{< figure src="img/new_header.jpg" alt="New front panel header connection" caption="New front panel header connection"  >}}
...
{{< figure src="img/new_home.jpg" alt="Post-build computer" caption="The computer in it's new home"  >}}
