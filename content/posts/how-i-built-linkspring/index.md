...
{{< figure src="img/tested-links.jpg" alt="A long list of links on a Tested video" caption="A long list of links on a Tested video"  >}}
...
{{< figure src="img/folder-structure.png" alt="Linkspring folder structure" caption="Linkspring folder structure"  >}}
