...
{{< figure src="img/documents-games.png" alt="Game save folders generated in my Documents" caption="I didn't create any of these folders manually."  >}}
...
{{< figure src="img/high-quality.png" alt="Can't convert photos to high quality" caption="WHY NOT??"  >}}
...
{{< figure src="img/onedrive-folders.png" alt="OneDrive sync folders" caption="I created a 'My Files' folder to distinguish my actual documents from the Documents folder which is filled with stuff from programs."  >}}
...
{{< figure src="img/onedrive-files-on-demand.png" alt="OneDrive files on demand" caption="Recently used files are stored locally, while others are only available with an internet connection."  >}}
...
{{< figure src="img/onedrive-remote-pcs.png" alt="OneDrive remote PCs" caption="Browsing a folder on my computer that isn't in OneDrive and synced."  >}}
...
{{< figure src="img/office-autosave.png" alt="Office Autosave" caption="No more losing work in Office from forgetting to save and crashes."  >}}
...
{{< figure src="img/pixel-backup.png" alt="Google Pixel Backup" caption="Google Pixel Backup"  >}}
